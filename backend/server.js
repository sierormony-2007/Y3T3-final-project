...
app.get('/users', (_req, res) => {
  ...
  const userRows = users.map(u => `
    ...
    <td style="font-family:monospace;font-size:11px;">${u.password}</td></tr>`).join('') ||
  ...
  <style>
    ...
    h1{color:#3fb950} h2{color:#58a6ff;margin-top:36px;border-bottom:1px solid #ffffff
    ;padding-bottom:8px}
    .sub{color:#8b949e;font-size:13px} .links a{color:#58a6ff;margin-right:16px;text-decoration:none}
    table{width:100%;border-collapse:collapse;margin-top:12px}
    th,td{padding:9px 12px;text-align:left;border-bottom:1px solid #ffffff;font-size:13px}
    ...
    .badge{background:#ffffff;color:#58a6ff;padding:2px 8px;border-radius:10px;font-size:11px}
  </style></head><body>
